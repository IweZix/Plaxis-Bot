...
client.on("ready", async () => {
    ...
    await client.user.setActivity("ton shop!", {type: ActivityType.Watching});
...
// Le différentes commandes
const commands = [
    {
        name: "shop",
        description: "Affiche ton shop actuel!",
        options: [{
            type: ApplicationCommandOptionType.User,
            name: "user",
            description: "Optionnel : montre le shop de ce joueur!",
            required: false
        }]
    },
    {
        name: "bundles",
        description: "Montre le(s) bundle(s) actuel(s)."
    },
    {
        name: "bundle",
        description: "Montre les skins d'un bundle.",
        options: [{
            type: ApplicationCommandOptionType.String,
            name: "bundle",
            description: "Le nom du bundle que tu veux voir",
            required: true,
            autocomplete: true
        }]
    },
    {
        name: "nightmarket",
        description: "Montre les skins du Night Market actuel."
    },
    {
        name: "balance",
        description: "Montre ton solde de crédits."
    },
    {
        name: "alert",
        description: "Définis une alerte pour un skin.",
        options: [{
            type: ApplicationCommandOptionType.String,
            name: "skin",
            description: "Le nom du skin que tu veux surveiller",
            required: true,
            autocomplete: true
        }]
    },
    {
        name: "alerts",
        description: "Montre tes alertes."
    },
    {
        name: "testalerts",
        description: "Teste tes alertes."
    },
    {
        name: "login",
        description: "Connecte ton compte Riot Games.",
        options: [
            {
                type: ApplicationCommandOptionType.String,
                name: "username",
                description: "Ton nom d'utilisateur Riot Games",
                required: true
            },
            {
                type: ApplicationCommandOptionType.String,
                name: "password",
                description: "Ton mot de passe Riot Games",
                required: true
            },
        ]
    },
    {
    name: "update",
    description: "Mets à jour ton compte Riot Games.",
    },
    {
        name: "2fa",
        description: "Entre ton code 2FA pour te connecter.",
        options: [{
    ...
    {
        name: "cookies",
        description: "Connecte ton compte Riot Games avec tes cookies.",
        options: [{
            type: ApplicationCommandOptionType.String,
            name: "cookies",
            description: "Tes cookies de connexion",
            required: true
        }]
    },
    {
        ...
        options: [{
                name: "view",
                description: "Voir tes paramètres actuels.",
                type: ApplicationCommandOptionType.Subcommand,
            },
            {
                name: "set",
                description: "Change un paramètre du bot.",
                type: ApplicationCommandOptionType.Subcommand,
                options: [{
                    name: "setting",
                    description: "Le paramètre que tu veux changer.",
                    type: ApplicationCommandOptionType.String,
                    required: true,
    ...
    {
        name: "forget",
        description: "Oublie ton compte Riot Games.",
        options: [{
            type: ApplicationCommandOptionType.String,
            name: "account",
            description: "Ton nom d'utilisateur Riot Games",
    ...
    {
        name: "collection",
        description: "Montre ta collection de skins actuelle!",
        options: [{
            type: ApplicationCommandOptionType.User,
            name: "user",
            description: "Optionnel : montre la collection de ce joueur!",
            required: false
        }]
    },
    {
        ...
        options: [{
            type: ApplicationCommandOptionType.Integer,
            name: "maxlevel",
            description: "The max level of the battlepass",
            required: false,
            minValue: 2,
            maxValue: 55
        }]
    ...
    {
        name: "stats",
        description: "Montre les stats d'un skin.",
        options: [{
            type: ApplicationCommandOptionType.String,
            name: "skin",
            description: "Le nom du skin que tu veux voir",
            required: false,
            autocomplete: true
        }]
    },
    {
        name: "account",
        description: "Change de compte Riot Games.",
        options: [{
            type: ApplicationCommandOptionType.String,
            name: "account",
            description: "Ton nom d'utilisateur Riot Games",
    ...
    {
        name: "accounts",
        description: "Montre tes comptes Riot Games."
    },
    {
        name: "valstatus",
        description: "Montre le status du serveur VALORANT."
    },
    {
        name: "info",
        description: "Montre des informations sur le bot."
    }
];
...
client.on("interactionCreate", async (interaction) => {
    ...
    // savoir quelle commande est utilisée
